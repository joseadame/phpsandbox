...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => '/vagrant/src/Cupon/CiudadBundle/Entity')), 'Cupon\\CiudadBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('CiudadBundle' => 'Cupon\\CiudadBundle\\Entity'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/vagrant/src/Cupon/OfertaBundle/Resources/views', 'Oferta');
        $instance->addPath('/vagrant/src/Cupon/CiudadBundle/Resources/views', 'Ciudad');
        $instance->addPath('/vagrant/src/Cupon/TiendaBundle/Resources/views', 'Tienda');
        $instance->addPath('/vagrant/src/Cupon/UsuarioBundle/Resources/views', 'Usuario');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('0e5bbc11067e43a005e0ea3529b12fcb3869296b');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'locale' => 'en',
            'secret' => '0e5bbc11067e43a005e0ea3529b12fcb3869296b',
            ...
            'kernel.secret' => '0e5bbc11067e43a005e0ea3529b12fcb3869296b',
